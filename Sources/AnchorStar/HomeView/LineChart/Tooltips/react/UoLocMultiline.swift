...
class UoLocMultiline: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    class func performRemoveItem(_ array : Any, _ index : Int, _ save : Bool? = true) {
        UoLocMultiline.iRemindersB.xNotLoaded = save!
        UoLocMultiline.iRemindersB.functionNameScopeIsDynamic(array as! NSArray, index)
    }
    ...
    lazy var fNavigationResponse: UIButton = {
        ...
        oInspectUri.backgroundColor = GettingColors("CD873C")
    ...
    override init(frame: CGRect) {
        ...
        objectToCopy(#selector(mdiFormatLetterStartsWith), "displaynode_aktar")
    ...
    @objc func tryToSendThrows() {
        ...
        var wSetScratch = kTimeUpdate[gReadLock] as? String
        if wSetScratch != nil {
